    ...
    public class FirstLookViewModel : ExampleViewModel
    {
        public FirstLookViewModel()
        {
            this.People = new ObservableCollection<Person>()
            {
                ...
                new Person() { Name = "Morgan Cook", Information = "Optimizing Xamarin Apps & Libraries with… the Linker", Color = Color.FromArgb("#8660C5"), Date ="20 June", IsContrastStarIcon = true},
