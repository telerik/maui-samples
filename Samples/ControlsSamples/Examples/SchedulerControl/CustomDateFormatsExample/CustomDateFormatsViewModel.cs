...
namespace QSF.Examples.SchedulerControl.CustomDateFormatsExample;

public class CustomDateFormatsViewModel : ExampleViewModel
{
    private ObservableCollection<Appointment> appointmentsSource;

    public CustomDateFormatsViewModel()
    {
